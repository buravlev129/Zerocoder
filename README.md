# Zerocoder
**Задания по курсу программирования на Python в унивеситете Zerocoder**


**OP06. Работа с модулями random и math. Создание собственных модулей и пакетов**
```python
import arithmetic
...
![Арифметические вычисления](LessonOP06/dz_2.png?raw=true "Арифметические вычисления")
